...
import { useLoginMutation, useLazyGetMeQuery } from "@/lib/api";
import { useDispatch } from "react-redux";
import { setCurrentUser } from "@/lib/slices/authSlice";
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="block font-normal text-gray-700 text-theme-sm dark:text-gray-400">Keep me signed in</span>
                  </div>
                  <Link href="/reset-password" className="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">Forgot password?</Link>
                </div>
                ...
                {(serverError || hookErrorMsg) && (
                  <Alert
                    ...
                    message={serverError || hookErrorMsg || "Something went wrong"}
                  />
                )}
